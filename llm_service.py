...
class LLMService:
    ...
    def explain_word(self, word: str, context: str = "") -> Optional[str]:
        ...
        Используй переносы строк для разделения секций. Не используй Markdown синтаксис.
        """
    ...
    def explain_phrase(self, phrase: str) -> Optional[str]:
        ...
        Современный перевод
        [как сказать то же самое сегодня. Можно привести несколько вариантов]

        Контекст
        [исторический или культурный контекст, когда и где использовалось]

        Происхождение
        [откуда пошло выражение, история происхождения]
