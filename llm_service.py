...
class LLMService:
    ...
    def explain_phrase(self, phrase: str) -> Optional[str]:
        ...
        "{phrase}" означает [краткое объяснение].

        [Если нужно, добавь контекст или происхождение в 1-2 предложениях].
    ...
    def characterize_hero(self, character_info: str) -> Optional[str]:
        ...
        - Исторический/культурный контекст (если применимо)

        Будь точен и основывайся на фактических знаниях русской литературы. Используй обычный текст без Markdown.
